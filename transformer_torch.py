...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_Q, input_K, input_V, attn_mask):
        ...
        # 输入进来的数据形状： Q: [batch_size , len_q , d_model], K: [batch_size , len_k , d_model], 
        #                    V: [batch_size , len_k , d_model], attn_mask: [batch_size, len_q, len_k]
...
class Encoder(nn.Module):
    ...
    def forward(self, enc_inputs):
        # enc_inputs 形状是： [batch_size , source_len]
...
class Decoder(nn.Module):
    ...
    def forward(self, dec_inputs, enc_inputs, enc_outputs): # dec_inputs : [batch_size , target_len]
        ...
        # 这个做的是交叉注意力机制中的mask矩阵，enc的输入是k，去看这个K里面哪些是pad符号，给到后面的模型；注意哦，Q肯定也是有pad符号，但是这里我不在意的，之前说了好多次了哈
        ...
        for layer in self.layers:
            ...
            dec_self_attns.append(dec_enc_attn)
